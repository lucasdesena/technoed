  ...
  final niveis = [
    ...
    TiposDificuldade([
      Forma(
        ...
        height: 42,
        width: 85,
        targetPosition: Posicao(54, 62),
        position: Posicao(100, 400),
        color: Colors.pink,
        targetColor: Colors.grey,
        shape: Triangulo(),
        rotationAngle: 0 / 360,
      ...
      Forma(
        ...
        height: 80,
        width: 160,
        targetPosition: Posicao(143, 91.7),
        position: Posicao(100, 400),
        color: Colors.red,
        targetColor: Colors.grey,
        shape: Triangulo(),
      ...
      Forma(
        ...
        height: 42,
        width: 85,
        targetPosition: Posicao(225, 115),
        position: Posicao(100, 400),
        color: Colors.blue,
        targetColor: Colors.grey,
        shape: Triangulo(),
      ...
      Forma(
        ...
        height: 80,
        width: 160,
        targetPosition: Posicao(105, 148),
        position: Posicao(100, 400),
        color: Colors.orange,
        targetColor: Colors.grey,
        shape: Triangulo(),
      ...
      Forma(
        ...
        height: 30,
        width: 110,
        targetPosition: Posicao(150, 230),
        position: Posicao(100, 400),
        color: Colors.yellow,
        targetColor: Colors.grey,
        shape: Paralelograma(flip: false),
